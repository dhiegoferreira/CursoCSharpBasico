...
{
    internal class DateTimeKindEPardraoISO8601
    {
        static void Main(string[] args)
        {
            //DateTimeKind: tipo enumerado especial que define três valores possíveis para a localidade
            // - Local [fuso horário do sistema. ex: São Paulo = GMT 3]
            // - Utc [fuso horário GMT (Greenwich Mean Time)
            // - Unspecified

            //Boa prática
            // - Armazenar em formato UTC (text:BD/jSON/Xml)
            // - Instanciar e mostrar em formato local

            //myDate.ToLocalTime() -- para converter para data local
            //myDate.ToUniversalTime() -- para converter para utc
